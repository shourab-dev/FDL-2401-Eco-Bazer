                ...
                <div class="swiper-slide">
                    <div class="row align-items-center">
                        ...
                        <div class="col-5 text-start bannerText">
                            ...
                            <a href="shop.html"><button>Shop Now <iconify-icon icon="mdi-light:arrow-right">
                                    </iconify-icon></button></a>
                        </div>
                    </div>
                </div>
                <div class="swiper-slide">
    ...
    <div class="container">
        <div class="headers">
            ...
            <div class="navigation">
                ...
                <a type="button" data-filter=".{{ $category->slug }}" class="pdNavButtons ">{{ $category->title }}</a>
                @endforeach
                ...
                <a href="{{ $url }}">
                    ...
                    <div class="details">
                        ...
                        <div class="review">
                            ...
                            <iconify-icon icon="twemoji:star" width="20" height="20"></iconify-icon>
                            <iconify-icon icon="twemoji:star" width="20" height="20"></iconify-icon>
                            <iconify-icon icon="heroicons:star-20-solid" width="20" height="20" style="color: #b3b3b3">
                            </iconify-icon>
                        </div>
                    </div>
                </a>
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-4 text-center middleItems">
                ...
                <a href="shop.html"><button>Shop Now <iconify-icon icon="ri:arrow-right-line"></iconify-icon>
                    </button></a>
            </div>
            <div class="col-4 d-none d-lg-block">
                    ...
                    <div class="swiper-wrapper">
                        ...
                        <div class="swiper-slide">
                            <div class="cart Vegetables">
                                <a href="#">
                                    <div class="imgBox">
                                        <img class="img-fluid" src="{{ asset('frontend/assets/img/Chanise.png')}}"
                                            alt="">
                                    </div>
                                    <div class="details text-start">
                        ...
                        <div class="swiper-slide">
                            <div class="cart fruits">
                                <a href="#">
                                    <div class="imgBox">
                                        <img class="img-fluid" src="{{ asset('frontend/assets/img/Ladies.png')}}"
                                            alt="">
                                    </div>
                                    <div class="details text-start">
                        ...
                        <div class="swiper-slide">
                            <div class="cart Vegetables">
                                <a href="#">
                                    <div class="imgBox">
                                        <img class="img-fluid" src="{{ asset('frontend/assets/img/Eggplant.png')}}"
                                            alt="">
                                    </div>
                                    <div class="details text-start">
                                        <a href="#">Eggplant</a>
                        ...
                        <div class="swiper-slide">
                            <div class="cart fruits">
                                <a href="#">
                                    <div class="imgBox">
                                        <img class="img-fluid" src="{{ asset('frontend/assets/img/GreenApple.png')}}"
                                            alt="">
                                    </div>
                                    <div class="details text-start">
                        ...
                        <div class="swiper-slide">
                            <div class="cart fruits">
                                <a href="#">
                                    <div class="imgBox">
                                        <img class="img-fluid" src="{{ asset('frontend/assets/img/GreenCapsicum.png')}}"
                                            alt="">
                                    </div>
                                    <div class="details text-start">
                        ...
                        <div class="swiper-slide">
                            <div class="cart Vegetables">
                                <a href="#">
                                    <div class="imgBox">
                                        <img class="img-fluid" src="{{ asset('frontend/assets/img/GreenChili.png')}}"
                                            alt="">
                                    </div>
                                    <div class="details text-start">
...
<section id="video">
    <div class="container">
        <div class="row">
            <a class="videoHome" data-autoplay="true" data-vbtype="video"
                href="https://www.youtube.com/watch?v=zep0sZs7JNA"><img class="img-fluid vid"
                    src="{{ asset('frontend/assets/img/Video.png')}}" alt=""></a>
        </div>
    </div>
</section>
<!-- *Video Section end -->
