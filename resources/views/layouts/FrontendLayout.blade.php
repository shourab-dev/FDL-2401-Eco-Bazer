               ...
               <div class="col-lg-3">
                  <div class="logo">
                     <a href="{{ route('homepage') }}"><img class="img-fluid"
                           src="{{ asset('frontend/assets/img/Logo.png')}}"></a>
                  </div>
               </div>
            ...
            <div class="offcanvas-body">
               <div class="cardProduct">
                  <div class="row align-items-center product">
                     <div class="col-5"><img class="img-fluid" src="{{ asset('frontend/assets/img/product.png')}}"
                           alt=""></div>
                     <div class="col-6">
                  ...
                  <div class="row align-items-center product">
                     <div class="col-5"><img class="img-fluid" src="{{ asset('frontend/assets/img/product_1.png')}}"
                           alt=""></div>
                     <div class="col-6">
                        <h6>Green Apple</h6>
